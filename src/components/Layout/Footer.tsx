    ...
    <footer className="bg-muted/30 border-t border-border/40 mt-20">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-muted-foreground text-sm">
              Discover the future of shopping with AI-powered recommendations and immersive product experiences.
            </p>
          </div>
        ...
        <div className="border-t border-border/40 mt-8 pt-8 text-center text-sm text-muted-foreground">
          <p>&copy; 2024 TrendNest. All rights reserved. Built with ❤️ for the future of eCommerce.</p>
        </div>
      </div>
    </footer>
  );
